""" Guideline .pdf importer."""

from beancount_reds_importers.guideline import guidelinereader
...
class Importer(guidelinereader.Importer, investments.Importer):
    IMPORTER_NAME = 'Guideline PDF'
    FILE_EXT = 'pdf'

    def custom_init(self):
        self.max_rounding_error = 0.04
        self.filename_pattern_def = '.*Guideline.*'
